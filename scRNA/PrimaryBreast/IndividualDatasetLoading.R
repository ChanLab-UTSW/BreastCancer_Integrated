...
setwd("/project/InternalMedicine/Chan_lab/s204665")
...
setwd("/project/InternalMedicine/Chan_lab/shared/FinalObjects/Individual_Datasets/Unfiltered")
...
setwd("/project/InternalMedicine/Chan_lab/s204665/PanCancer_Breastsamples")
...
fullmat <- read.csv("/project/InternalMedicine/Chan_lab/s204665/Wu Files/Wu_EMBO_countr_matrix.csv")
fullmat[1:5,1:5]

rownames(fullmat) <- fullmat[,1]
fullmat[1:5,1:5]
#actual like full matrix what
fullmetadata <- read.csv("/project/InternalMedicine/Chan_lab/s204665/Wu Files/Wu_EMBO_metadata.csv")
...
#write.csv(fullmetadata, file = "wumetadata.csv")
